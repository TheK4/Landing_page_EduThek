        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="flex justify-center items-center mt-16 border-t pt-12">
                <h2 className="tracking-tight text-gray-800 text-4xl lg:text-5xl font-extrabold md:!leading-[55px] mr-4 hover:text-cognac-500">5K</h2>
                <p className="text-m tracking-tighter mr-4 text-gray-500">Usuarios Ativos</p>
                <h2 className="tracking-tight text-gray-800 text-4xl lg:text-5xl font-extrabold md:!leading-[55px] mr-4 hover:text-cognac-500">250</h2>
                <p className="text-m tracking-tight mr-4 text-gray-500">Professores Qualificados</p>
                <h2 className="tracking-tight text-gray-800 text-4xl lg:text-5xl font-extrabold md:!leading-[55px] mr-4 hover:text-cognac-500">10</h2>
